...
public class FormListagemAluno extends DialogPadrao {
    
    private List<Aluno> listagem;
    
    public FormListagemAluno(Window parent) {
    ...
    private void initComponents() {
        ...
        if (tablePadrao1.getColumnModel().getColumnCount() > 0) {
            ...
            tablePadrao1.getColumnModel().getColumn(2).setResizable(false);
            tablePadrao1.getColumnModel().getColumn(2).setPreferredWidth(300);
        }
    ...
    private void btnExcluirUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirUsuarioActionPerformed
        new AlunoController().deletar(getAlunoSelecionado());
        atualizaListagem();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new FormCadastroAluno(getAlunoSelecionado()).setVisible(true);
        atualizaListagem();
    ...
    private void atualizaListagem() {
        ...
        listagem = new AlunoController().listagem(txtNome.getText());
        if(listagem != null) {
            for(Aluno a : listagem) {
                tablePadrao1.adicionarLinha(new Object[] {a.getCodigo(), a.getNome(), a.getEmail()});
            }
        }
    }
